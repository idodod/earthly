...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.8.14+earthly`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.8.14+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.8.14+DOWNLOAD_DIND`
...
| `github.com/earthly/earthly:v0.8.14` | `github.com/earthly/earthly:v0.8.14+build` | `github.com/earthly/earthly:v0.8.14+build/out.bin` | `github.com/earthly/earthly:v0.8.14+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.8.14` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
